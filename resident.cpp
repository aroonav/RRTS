...
resident::resident(std::string residentName, std::string address, std::string contact, std::string IDNumber)
{
...
int resident::request_raiser(std::string location, std::string startPoint, std::string endPoint)
{
	...
	if (fout.is_open())
	{	fout<<requestID+1<<","<<location<<","<<startPoint<<","<<endPoint<<","<<residentName<<","<<address<<","<<contact<<","<<IDNumber<<","<<priority<<","<<rawMaterials<<","<<machinesRequired<<","<<personnelRequired<<std::endl;
		fout.close();
